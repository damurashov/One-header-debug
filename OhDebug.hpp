...
# define ohdebugstr(ctx, ...) ohdebugstub0_(__VA_ARGS__)
# define ohdebuggroup(ctx, ...) ohdebugstub0_(__VA_ARGS__)
# define ohdebugassert(ctx, ...) ohdebugstub0_(__VA_ARGS__)
# define ohdebugsecteveryn(ctx, ...) ohdebugstub0_(__VA_ARGS__)
# define ohdebugeveryn(ctx, ...) ohdebugstub0_(__VA_ARGS__)
# define ohdebugsectif(ctx, ...) ohdebugstub0_(__VA_ARGS__)
# define ohdebugif(ctx, ...) ohdebugstub0_(__VA_ARGS__)
# define ohdebugsectonce(ctx, ...) ohdebugstub0_(__VA_ARGS__)
# define ohdebugonce(ctx, ...) ohdebugstub0_(__VA_ARGS__)
#endif
